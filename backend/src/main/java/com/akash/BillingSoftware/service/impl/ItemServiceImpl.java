...
//         delete the image and remove the item
    ...
    private ItemResponse convertToResponse(ItemEntity entity){
        return ItemResponse.builder()
                ...
                .categoryId(entity.getCategoryEntity() != null ? entity.getCategoryEntity().getCategoryId() : null)
                .description(entity.getDescription())
                .categoryName(entity.getCategoryEntity() != null ? entity.getCategoryEntity().getName() : "Uncategorized")
